...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [YQHTextView maxCharactersPerLine];
...
{
    return [YQHTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [YQHTextView maxCharactersPerLine]) + 1;
}
